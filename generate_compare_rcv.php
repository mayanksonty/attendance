...
<table width="90%" style="border:1px solid black;" id="generateTable" cellpadding="0" border="1" cellspacing="0" align="center">
    ...
    <tr><td colspan="20" align="center" style="background-color:#f5ecd4; font-weight:600; ">
        	<font size="2">RUNGTA GROUP OF ENGINEERING AND TECHNOLOGY,&nbsp;Bhilai</font>
        </td></tr>
	<tr><td colspan="20" align="center" style="background-color:#f5ecd4; font-weight:600;">
...
<?php	
		...
		{		
          ...
          for($p=$month_id;$p>=1;$p--)
          {
            	...
            	echo"<th style='background-color:#8fbc8f' width='70'>"."<font size='2'>"."Percent-".$month1."</font>"."</th>";
		       }
    echo"</tr>";
		...
		for($p=$month_id;$p>=1;$p--)
          {
            	...
            	echo"<th style='background-color:#8fbc8f' width='90'>"."<font size='2'>"."Percent-"."Up to ".$month1."</font>"."</th>";
		       }
    echo"</tr>";
