...
<script>
	...
	{
			alert("Be cautious while Incrementing Semesters!!");
...
<form action="update_semester_rcv.php" method="post">
<table width="100%" cellspacing="5" class="formTable">
 <tr>
   <th align="center"><u>
      Update semester with one click
   </u></th>
   </tr>
   <!--
   ...
   <tr><td align="center"><input type="submit" name="update" value="Update" class="formButton"></td></tr>
</table>
